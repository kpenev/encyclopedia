...
This may result in the dimise of the planet much sooner than tides.

\subsection{Spin-orbit locking}

On their way to the synchonized and circularized state described above, planets
...
significantnly eccentric orbt. For circular orbits, the time dependence of the
...
assume its axis of rotation is aligned with the orbital angular momemntum, each
