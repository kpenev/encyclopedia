...
%$\Omega_\star$ and $\Omega_p$ their angular velocities, and let $a_0$
%and $e_0$ be the initial orbital semimajor axis and eccentricity. For
%the sake of simplifying the algebra, let us further assume that the initial
%spin angular momenta are both parallel to the orbital angular momentum. Under
%these assumptions, the initial angular momentum is given by:
%
%\begin{equation}
%%
%    L_0
...
%    +
%%
%    M_\star M_p \sqrt{\frac{G a_0 (1 - e_0^2)}{M_\star + M_p}}
%%
%\end{equation}
%
%
